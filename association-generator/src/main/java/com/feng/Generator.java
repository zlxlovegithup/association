...
/**
 * Created by zlx on 2020/2/27.
 *  AutoGenerator是MyBatis-Plus的代码生成器，通过 AutoGenerator 可以快速生成 Entity、Mapper、Mapper
...
public class Generator {
     ...
     * @author Terry
     */
    private void atuoGenerator(DataSourceConfig dataSourceConfig,
    ...
    private static DataSourceConfig getDataSourceConfig() {
        ...
        return new DataSourceConfig().setDbType(DbType.MYSQL) //mysql数据库
                .setUrl(dbUrl)   //数据库链接地址
                .setUsername("root")  //数据库用户名称
                .setPassword("123456") //数据库密码
                .setDriverName("com.mysql.jdbc.Driver"); //数据库驱动名称
    }
